...
Critical Jekyll-related code are located in `_includes/` and `_layouts/`. Most of them are [Liquid](https://github.com/Shopify/liquid/wiki) templates.
...
weibo_username: huxpro      # the footer would be auto-updated.
...
![blog sidebar](http://huangxuan.me/img/blog-sidebar.jpg)
...
Modules *[Featured Tags](#featured-tags)*, *[Mini About Me](#mini-about-me)* and *[Friends](#friends)* are turned on by default and you can add your own. The sidebar is naturally responsive, i.e. be pushed to bottom in a smaller screen (`<= 992px`, according to [Bootstrap Grid System](http://getbootstrap.com/css/#grid))
...
![blog keynote](http://huangxuan.me/img/blog-keynote.jpg)

There is an increased trend to use Open Web technology for keynotes and presentations via Reveal.js, Impress.js, Slides, Prezi etc. I consider a modern blog should have first-class support to embed these HTML based presentation so **Keynote layout** are made.
...
![blog md navbar](http://huangxuan.me/img/blog-md-navbar.gif)
